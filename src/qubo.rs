...
impl Qubo {
    ...
    /// The convex symmetric form is generated by first making the QUBO symmetric, then shifting the diagonal enough to make the Hessian positive definite.
    ///
    ...
    pub fn convex_symmetric_form(&self) -> Self {
        ...
        // shift by enough to move the minimum eigenvalue slightly above zero.
