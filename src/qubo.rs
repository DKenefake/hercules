...
impl Qubo {
    ...
    /// When the `sdp` feature is enabled, the diagonal shift is initialized using the mixing cut SDP solver.
    /// Otherwise a spectral fallback based on the minimum eigenvalue is used.
    ///
    ...
    pub fn convex_symmetric_form(&self) -> Self {
        ...
        let p_sym = {
            ...
            p_sym.make_diag_array_transform(&diag_shift)
        };
